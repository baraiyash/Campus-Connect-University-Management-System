...
//    JButton submit, cancel;
//    
//    String empId,Role; // Variable to store the empId for the logged-in employee
//
//    // Constructor accepting empId
//    public UpdateTeacher(String empId,String Role) {
//        this.empId = empId; // Set the empId passed during object creation
//        this.Role = Role;
//        
//        setSize(900, 650);
//        setLocation(350, 50);
...
//        add(tfbranch);
//
//        // Fetch teacher details based on empId passed in constructor
//        try {
//            Conn c = new Conn();
...
//    }
//
//    // Main method should pass dynamic empId
//    public static void main(String[] args) {
////        String loggedInEmpId = "101"; // Simulate the empId from login
//        new UpdateTeacher("101","Admin"); // Pass the logged-in empId dynamically
//    }
//}
