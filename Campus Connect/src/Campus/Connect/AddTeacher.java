...
//    long first4 = Math.abs((ran.nextLong() % 9L) + 1L);
//    
//    AddTeacher() {
//        
//        setSize(900, 700);
...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    AddTeacher() {
        ...
        Font largeFont = new Font("Serif", Font.PLAIN, 25);
        ...
        tfname = new JTextField();
        tfname.setBounds(200, 150, 250, 40); // Increased height
        tfname.setFont(largeFont); // Set font size
        add(tfname);
        ...
        tffname = new JTextField();
        tffname.setBounds(700, 150, 250, 40); // Increased height
        tffname.setFont(largeFont); // Set font size
        add(tffname);
        ...
        JLabel lbldob = new JLabel("Date of Birth");
        lbldob.setBounds(500, 200, 150, 30);
        lbldob.setFont(new Font("serif", Font.BOLD, 25));
        add(lbldob);
        
        dcdob = new JDateChooser();
        dcdob.setBounds(700, 200, 250, 40); // Increased height
        add(dcdob);
        ...
        tfaddress = new JTextField();
        tfaddress.setBounds(200, 250, 750, 40); // Increased height and width
        tfaddress.setFont(largeFont); // Set font size
        add(tfaddress);
        ...
        tfphone = new JTextField();
        tfphone.setBounds(200, 300, 250, 40); // Increased height
        tfphone.setFont(largeFont); // Set font size
        add(tfphone);
        
        JLabel lblemail = new JLabel("Email Id");
        lblemail.setBounds(500, 300, 150, 30);
        lblemail.setFont(new Font("serif", Font.BOLD, 25));
        add(lblemail);
        
        tfemail = new JTextField();
        tfemail.setBounds(700, 300, 250, 40); // Increased height
        tfemail.setFont(largeFont); // Set font size
        add(tfemail);
        
        JLabel lblx = new JLabel("Class X (%)");
        lblx.setBounds(50, 350, 150, 30);
        lblx.setFont(new Font("serif", Font.BOLD, 25));
        add(lblx);
        
        tfx = new JTextField();
        tfx.setBounds(200, 350, 250, 40); // Increased height
        tfx.setFont(largeFont); // Set font size
        add(tfx);
        
        JLabel lblxii = new JLabel("Class XII (%)");
        lblxii.setBounds(500, 350, 150, 30);
        lblxii.setFont(new Font("serif", Font.BOLD, 25));
        add(lblxii);
        
        tfxii = new JTextField();
        tfxii.setBounds(700, 350, 250, 40); // Increased height
        tfxii.setFont(largeFont); // Set font size
        add(tfxii);
        
        JLabel lblaadhar = new JLabel("Aadhar Number");
        lblaadhar.setBounds(50, 400, 150, 30);
        lblaadhar.setFont(new Font("serif", Font.BOLD, 25));
        add(lblaadhar);
        
        tfaadhar = new JTextField();
        tfaadhar.setBounds(200, 400, 250, 40); // Increased height
        tfaadhar.setFont(largeFont); // Set font size
        add(tfaadhar);
        ...
        String[] course = {"B.Tech", "BBA", "BCA", "Bsc", "Msc", "MBA", "MCA", "MCom", "MA", "BA"};
        cbcourse = new JComboBox<>(course);
        cbcourse.setBounds(200, 450, 250, 40); // Increased height
        cbcourse.setBackground(Color.WHITE);
        add(cbcourse);
        ...
        String[] branch = {"Computer Science", "Electronics", "Mechanical", "Civil", "IT"};
        cbbranch = new JComboBox<>(branch);
        cbbranch.setBounds(700, 450, 250, 40); // Increased height
        cbbranch.setBackground(Color.WHITE);
        add(cbbranch);
